                    ...
                    <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-l">
                        <div class="flex items-center">
                            ...
                            <div class="ml-1 text-lg leading-7 font-semibold text-gray-900 dark:text-white">Data
                                @if(config('app.data_source_url'))
                                    <a href="{{ config('app.data_source_url') }}" class="ml-1 text-gray-600 dark:text-gray-400 text-sm underline">(source)</a>
                                @endif
                            </div>
                        </div>
