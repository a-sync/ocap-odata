                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2">
                        ...
                        <div class="p-6">
                            <div class="flex items-center">
                                <div class="ml-2 text-lg leading-7 font-semibold"><a href="{{ $ep }}$metadata?$format=json" class="underline text-gray-900 dark:text-white">CSDL JSON</a></div>
                            </div>
                            <div class="ml-4">
                                <pre class="mt-2 text-gray-600 dark:text-gray-400 text-sm">{{ $ep }}$metadata?$format=json</pre>
                            </div>
                            <div class="flex items-center">
                                <div class="ml-2 text-lg leading-7 font-semibold"><a href="{{ $ep }}$metadata?$format=xml" class="underline text-gray-900 dark:text-white">CSDL XML</a></div>
                            </div>
                            <div class="ml-4">
                                <pre class="mt-2 text-gray-600 dark:text-gray-400 text-sm">{{ $ep }}$metadata?$format=xml</pre>
                            </div>
                            <div class="flex items-center">
                                <div class="ml-2 text-lg leading-7 font-semibold"><a href="{{ $ep }}openapi.json" class="underline text-gray-900 dark:text-white">OpenAPI v3</a></div>
                            </div>
                            <div class="ml-4">
                                <pre class="mt-2 text-gray-600 dark:text-gray-400 text-sm">{{ $ep }}openapi.json</pre>
                            </div>
                        </div>
